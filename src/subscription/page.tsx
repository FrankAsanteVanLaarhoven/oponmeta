    ...
    return (
        <main className="max-w-6xl mx-auto py-10 px-4">
            <div className="text-center mb-8">
                <h1 className="text-3xl font-bold text-[#0a174e] mb-4">Pricing Plans</h1>
                <p className="text-gray-600 text-lg">Choose the perfect plan for your learning journey</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* Free Plan */}
                <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
                    <h3 className="text-2xl font-bold text-[#0a174e] mb-4">Free</h3>
                    ...
                    <button className="w-full bg-gray-200 text-gray-800 py-2 px-4 rounded-lg font-semibold">
                        Get Started
                    </button>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-yellow-400 relative">
                    ...
                    <h3 className="text-2xl font-bold text-[#0a174e] mb-4">Pro</h3>
                ...
                {/* Enterprise Plan */}
                <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
                    <h3 className="text-2xl font-bold text-[#0a174e] mb-4">Enterprise</h3>
