  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      >
        ...
        {showNames && <span className="font-medium">{currentLang.name}</span>}
        {showCodes && <span className="text-xs opacity-75">({currentLang.code})</span>}
        {currentLang.isUK && (
          <span className="ml-1 text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded-full">
            UK
          </span>
              ...
              .map((lang) => (
                <button
                  ...
                  className={`
                    ...
                    ${currentLanguage === lang.code ? 'bg-blue-100 text-blue-900' : 'text-gray-700'}
                  `}
                >
