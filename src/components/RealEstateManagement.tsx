...
import { 
  ...
  Home, Building, DollarSign, MapPin, Calculator, FileText
} from 'lucide-react';
...
const RealEstateManagement = () => {
  ...
  const [courses, setCourses] = useState([
    {
      ...
      students: 1247,
      price: 399,
      description: 'Master real estate investment strategies, portfolio management, and market analysis techniques.',
      topics: ['Investment Analysis', 'Portfolio Diversification', 'Market Research', 'Risk Management'],
      skills: ['Real Estate Investment', 'Financial Analysis', 'Market Research', 'Portfolio Management'],
      status: 'active',
      category: 'Investment',
      certificate: true,
      liveSessions: true
    },
    {
      ...
      students: 2156,
      price: 299,
      description: 'Learn comprehensive property management including tenant relations, maintenance, and operations.',
      topics: ['Tenant Management', 'Property Maintenance', 'Legal Compliance', 'Financial Reporting'],
      skills: ['Property Management', 'Tenant Relations', 'Maintenance Coordination', 'Legal Compliance'],
      status: 'active',
      category: 'Management',
      certificate: true,
      liveSessions: true
    },
    {
      ...
      instructor: 'Attorney Lisa Chen',
      level: 'Advanced',
      duration: '12 weeks',
      rating: 4.9,
      students: 892,
      price: 549,
      description: 'Comprehensive legal training for real estate professionals covering contracts, regulations, and compliance.',
      topics: ['Contract Law', 'Regulatory Compliance', 'Dispute Resolution', 'Ethics'],
      skills: ['Real Estate Law', 'Contract Negotiation', 'Regulatory Compliance', 'Legal Analysis'],
      status: 'active',
      category: 'Legal',
      certificate: true,
      liveSessions: false
  ...
  const categories = ['Investment', 'Management', 'Legal', 'Development', 'Valuation', 'Marketing'];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Master real estate investment, property management, and estate planning. Learn from industry experts 
            and develop skills for success in the dynamic real estate market.
          </p>
        </motion.div>
          ...
          <div className="lg:col-span-2">
            {activeTab === 'overview' && (
              ...
              >
                ...
                {/* About Real Estate & Estate Management */}
                <div className="bg-white rounded-lg shadow p-6">
                  <h3 className="text-2xl font-bold text-[#0a174e] mb-4">About Real Estate & Estate Management</h3>
                ...
                {/* Featured Courses */}
                <div className="bg-white rounded-lg shadow p-6">
                  <h3 className="text-2xl font-bold text-[#0a174e] mb-4">Featured Real Estate Courses</h3>
            ...
            {activeTab === 'specializations' && (
              ...
              >
                <h3 className="text-2xl font-bold text-[#0a174e] mb-6">Real Estate Specializations</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    {
                      ...
                      skills: ['Financial Analysis', 'Market Research', 'Portfolio Management', 'Risk Assessment']
                    },
                    {
                      name: 'Property Management',
                      icon: Building,
                      description: 'Property operations, tenant relations, maintenance',
                      courses: 8,
                      avgSalary: '$60,000 - $120,000',
                      skills: ['Tenant Management', 'Maintenance Coordination', 'Financial Reporting', 'Legal Compliance']
                    },
                    {
                      name: 'Real Estate Law',
                      icon: FileText,
                      description: 'Legal compliance, contracts, regulatory requirements',
                      courses: 6,
                      avgSalary: '$90,000 - $180,000',
                      skills: ['Contract Law', 'Regulatory Compliance', 'Legal Analysis', 'Dispute Resolution']
                    },
                    {
                      name: 'Real Estate Development',
                      icon: Home,
                      description: 'Project development, construction management, planning',
                      courses: 10,
                      avgSalary: '$100,000 - $200,000',
                      skills: ['Project Management', 'Construction Oversight', 'Planning & Zoning', 'Financial Modeling']
                    },
                    {
                      name: 'Valuation & Appraisal',
                      icon: Calculator,
                      description: 'Property valuation, market analysis, appraisal techniques',
                      courses: 7,
                      avgSalary: '$70,000 - $130,000',
                      skills: ['Property Valuation', 'Market Analysis', 'Appraisal Methods', 'Data Analysis']
                    },
                    {
                      name: 'Real Estate Marketing',
                      icon: Target,
                      description: 'Marketing strategies, sales techniques, client relations',
                      courses: 9,
                      avgSalary: '$65,000 - $140,000',
                      skills: ['Marketing Strategy', 'Sales Techniques', 'Client Relations', 'Digital Marketing']
                    }
                  ].map(specialization => (
                    <div key={specialization.name} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-[#0a174e] mb-1">{specialization.name}</h4>
                          <p className="text-gray-600 text-sm mb-2">{specialization.description}</p>
                          <div className="flex items-center gap-4 mb-3">
                            <span className="text-sm text-gray-500">{specialization.courses} courses</span>
                            <span className="text-sm text-green-600 font-medium">{specialization.avgSalary}</span>
                          </div>
            ...
            {activeTab === 'careers' && (
              <motion.div
                ...
                className="bg-white rounded-lg shadow p-6"
              >
                <h3 className="text-2xl font-bold text-[#0a174e] mb-6">Career Paths in Real Estate</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    {
                      title: 'Real Estate Investor',
                      description: 'Invest in properties and manage real estate portfolios',
                      salary: '$80,000 - $500,000+',
                      requirements: ['Investment capital', 'Market knowledge', 'Financial analysis', 'Risk management']
                    },
                    {
                      title: 'Property Manager',
                      description: 'Manage residential and commercial properties',
                      salary: '$60,000 - $120,000',
                      requirements: ['Property management license', 'Customer service skills', 'Financial literacy']
                    },
                    {
                      title: 'Real Estate Attorney',
                      description: 'Provide legal services for real estate transactions',
                      salary: '$90,000 - $200,000',
                      requirements: ['Law degree', 'Bar certification', 'Real estate law specialization']
                    },
                    {
                      title: 'Real Estate Developer',
                      description: 'Develop and manage real estate projects',
                      salary: '$100,000 - $300,000+',
                      requirements: ['Project management', 'Construction knowledge', 'Financial modeling']
                    }
                  ].map(career => (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">Real Estate Professionals:</span>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-3">
                {[
                  { name: 'David Thompson', expertise: 'Real Estate Investment', courses: 5 },
                  { name: 'Sarah Johnson', expertise: 'Property Management', courses: 4 },
                  { name: 'Attorney Lisa Chen', expertise: 'Real Estate Law', courses: 3 }
                ].map(expert => (
        ...
        {showCreateModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <h3 className="text-2xl font-bold text-[#0a174e] mb-6">Create New Real Estate Course</h3>
              <div className="space-y-4">
        ...
        {showEditModal && editingCourse && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <h3 className="text-2xl font-bold text-[#0a174e] mb-6">Edit Real Estate Course</h3>
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Course Title</label>
