  ...
  const initializeProfiles = async () => {
    try {
      ...
      setAdaptivePath(path);
              ...
              const recommendations = await aiPersonalizationEngine.getPersonalisedRecommendations(userId);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Personalised learning profile generated by AI
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  AI-generated personalised learning journey
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {adaptivePath && (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your personalised learning adventure
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Scientifically-optimised review schedule
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
