...
const DramaTheatrePerformance = () => {
  ...
  const [courses, setCourses] = useState([
    {
      ...
      description: 'Learn the basics of acting and performance techniques',
      level: 'Beginner',
      duration: '8 weeks',
      rating: 4.7,
      students: 2345,
      price: 129,
      area: 'Acting',
      topics: ['Voice Training', 'Movement', 'Character Development', 'Scene Study'],
      skills: ['Voice Projection', 'Physical Expression', 'Character Analysis', 'Performance']
    },
    {
      id: 2,
      title: 'Theatre Production Management',
      description: 'Master the art of theatre production and stage management',
      level: 'Intermediate',
      duration: '10 weeks',
      rating: 4.8,
      students: 1234,
      price: 159,
      area: 'Production',
      topics: ['Stage Management', 'Lighting Design', 'Set Design', 'Production Planning'],
      skills: ['Stage Management', 'Technical Design', 'Project Planning', 'Team Coordination']
    },
    {
      id: 3,
      title: 'Advanced Performance Techniques',
      description: 'Advanced acting and performance methods for experienced performers',
      level: 'Advanced',
      duration: '12 weeks',
      rating: 4.9,
      students: 876,
      price: 189,
      area: 'Advanced Acting',
      topics: ['Method Acting', 'Shakespeare', 'Contemporary Theatre', 'Performance Analysis'],
      skills: ['Method Acting', 'Classical Performance', 'Contemporary Styles', 'Performance Analysis']
    }
  ]);
  ...
  const performanceAreas = [
    { name: 'Acting', icon: <Theater className="w-6 h-6" />, description: 'Performance and character development' },
    { name: 'Theatre Production', icon: <Building className="w-6 h-6" />, description: 'Stage management and production' },
    { name: 'Voice & Speech', icon: <Mic className="w-6 h-6" />, description: 'Voice training and speech techniques' },
    { name: 'Movement & Dance', icon: <Activity className="w-6 h-6" />, description: 'Physical expression and movement' },
    { name: 'Directing', icon: <Video className="w-6 h-6" />, description: 'Theatre direction and leadership' },
    { name: 'Dramatic Writing', icon: <Lightbulb className="w-6 h-6" />, description: 'Playwriting and script development' }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
            ...
            <div className="bg-indigo-700 bg-opacity-50 rounded-lg p-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-2xl font-bold">4,455</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8">
            {['overview', 'courses', 'performance-areas', 'career-paths'].map((tab) => (
              <button
                key={tab}
        ...
        <div className="mt-8">
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <p className="text-gray-600">
                  From acting fundamentals to theatre production management, our courses prepare you for 
                  careers in the performing arts and entertainment industry.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  >
                    ...
                    <option value="Advanced Acting">Advanced Acting</option>
                  </select>
                  <button
          ...
          {activeTab === 'performance-areas' && (
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-6">Performance Areas</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {careerPaths.map((path, index) => (
                    <div key={index} className="border border-gray-200 rounded-lg p-6">
                      ...
                      <p className="text-indigo-600 font-semibold mb-3">{path.salary}</p>
                      <div>
...
export default DramaTheatrePerformance;
