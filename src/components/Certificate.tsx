    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#0a174e] to-[#1a2a6b] p-8">
      <div className="bg-white rounded-2xl shadow-2xl border-4 border-yellow-400 max-w-2xl w-full p-10 relative">
        <div className="flex justify-between items-center mb-8">
          <img src="/oponmeta-logo .png" alt="OponMeta Logo" className="h-20 w-20 drop-shadow-lg border-4 border-yellow-400 rounded-full bg-white p-2" />
        ...
        <div className="flex justify-between items-end mt-12">
          ...
          <div className="flex flex-col items-center">
            <img src="/oponmeta-logo .png" alt="OponMeta Seal" className="h-16 w-16 rounded-full border-2 border-yellow-400 shadow-lg" />
